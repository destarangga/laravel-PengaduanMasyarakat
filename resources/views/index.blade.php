...
<body>
    ...
    <section class="baris">
        ...
        <div class="kolom kolom2">
            <img src="{{asset('assets/image/bgr.png')}}"  alt="">
        </div>
    </section>
    ...
    <section class="form-container">
        ...
        <div class="card laporan-card">
            ...
            <div class="article">
                <p>{{\Carbon\Carbon::parse($report['created_at'])
                ->format('j-F-Y')}} : {{$report['nama']}}</p>
                <div class="content">
                    <div class="text">
                    {{$report['pengaduan']}}
                    </div>
            ...
            <div stle="display: flex; justify-content: flex-end; margin-top: 10px">
                <!-- reports ny mengambil dari nama yang di compact -->
                {!! $reports->links() !!}
            </div>
        </div>
    </section>
